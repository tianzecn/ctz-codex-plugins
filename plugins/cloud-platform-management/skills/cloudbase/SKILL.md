---
name: cloudbase
description: Use this skill for Tencent CloudBase projects, including Web apps, WeChat Mini Programs, auth, NoSQL/MySQL databases, cloud functions, CloudRun, storage, AI model integration, MCP setup, deployment, resource inspection, and troubleshooting.
metadata:
  version: 2.20.2
