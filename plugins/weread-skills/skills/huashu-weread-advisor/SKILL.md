...
- 请求 body 必须带 `skill_version` 字段——**值的权威来源**：同插件内底层 weread skill `../weread-skills/SKILL.md` 顶部 frontmatter 的 `version` 字段（当前 `1.0.3`，会变；别从 prompt 或老模板里抄）
- 接口文档和参数详情见同插件内底层 weread skill：`../weread-skills/SKILL.md`
