...
- `weread-skills`: WeRead official skills zip plus alchaincyf/huashu-weread packaged as a Codex plugin for book search, bookshelf lookup, notes and highlights, book reviews, reading statistics, recommendations, reading blind-spot analysis, thinking-structure analysis, note alchemy, and reading reviews through `WEREAD_API_KEY`.
