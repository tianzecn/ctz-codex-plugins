...
- `huashu`: alchaincyf/nuwa-skill and alchaincyf/darwin-skill packaged as a Codex plugin with `huashu-nuwa` for distilling public figures or themes into runnable perspective skills, plus `darwin-skill` for evaluating and optimizing Agent Skills.
