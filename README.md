...
- `weread-skills`: WeRead official skills zip packaged as a Codex plugin for book search, bookshelf lookup, notes and highlights, book reviews, reading statistics, and recommendations through `WEREAD_API_KEY`.
